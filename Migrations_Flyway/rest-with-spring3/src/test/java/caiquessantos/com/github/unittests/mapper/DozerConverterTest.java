package caiquessantos.com.github.unittests.mapper;
...
import caiquessantos.com.github.unittests.mapper.mocks.MockPerson;
...
public class DozerConverterTest {
    ...
    //testa se os atributos de uma entidade x são correspondentes aos atributos de seus VO
    @Test
    ...
    //testa se os atributos de uma lista de entidade x são correspondentes aos 
    //atributos de uma lista de seus VOs
    @Test
    ...
    //testa se os atributos de um VO x são correspondentes aos atributos de sua entidade
    @Test
    ...
    //testa se os atributos de uma lista de VOs x são correspondentes aos 
    //atributos de uma lista de suas entidades
    @Test
